...
# -*- coding: utf-8 -*-
"""
Created on Mon Mar  9 12:00:31 2020
...
#
##=========================================================================
### adding a n ew column called ones before the data
...
cols = data.shape[1]  # les dimension du data
...
def gradientDescent(X, y, theta, alpha, iters):
    ...
    parameters = int(theta.ravel().shape[1])  # Recuper le nombre de colone = 2
